...
export const moduleTableOwnership = {
  ...
  billing: ["billing_handoff_requests", "billing_handoff_batches"],
...
export const staffingDbManifest = {
  ...
  dialect: "postgres",
  migrationFiles: [
    "0001_initial_staffing_ops.sql",
    "0002_billing_handoff_batches.sql",
    "0003_billing_handoff_requests.sql"
  ],
