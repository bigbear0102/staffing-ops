...
export type BillingHandoffRequestStatus = "pending_export" | "exported" | "cancelled";
...
export interface BillingHandoffRequest {
  readonly id: string;
  readonly organizationId: string;
  readonly clientAccountId: string;
  readonly siteId: string;
  ...
  readonly billingPeriodEnd: string;
  readonly billRateKrw: number;
  readonly status: BillingHandoffRequestStatus;
  readonly requestedAt: string;
